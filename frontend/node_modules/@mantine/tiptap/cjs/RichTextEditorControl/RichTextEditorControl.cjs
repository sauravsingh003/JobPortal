...
const RichTextEditorControlBase = react.forwardRef(({ className, icon: Icon, ...others }, ref) => /* @__PURE__ */ jsxRuntime.jsx(RichTextEditorControl, { ref, ...others, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { style: { width: core.rem(16), height: core.rem(16) } }) }));
